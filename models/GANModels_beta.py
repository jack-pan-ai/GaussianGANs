...
class FC(nn.Module):
    ...
    def forward(self, w):
        ...
        '''
        w = self.l1(w).reshape(
            [-1, self.channels, self.seq_len])  # [batch_size, emb_size] -> [batch_size, channels, seqlength]
...
class Discriminator(nn.Module):
    def __init__(self,
        ...
        self.transformer_discriminator = TransformerDecoder_discriminator(depth=depth, emb_size=emb_size,
                                                                          num_heads=num_heads)
